...
## X / Twitter (each under 280 chars)
...
> Built for the @monad hackathon: Monad Meadow 🌾
...
**Variant 1 — build story**

> 🌿 Excited to share Monad Meadow — our @monad hackathon project, now live on Monad testnet.
>
> It's a calm 2D multiplayer world: you and everyone else online wander a shared farmland-and-dungeon meadow, gather glowing crystals, and turn them into real onchain assets. Mint a crystal as an ERC-721 NFT for a MON micro-transaction, or trade it peer-to-peer through an onchain escrow marketplace.
>
> Under the hood:
> • Real-time multiplayer via a Cloudflare Worker + Durable Object over WebSockets
> • A vanilla-JS canvas client with zero dependencies
...
> We built a game where the loot is real. 💎
>
...
## 30-second demo video — shot list (6 beats)

1. **0:00–0:05 — Arrive.** Cold open on the meadow. Character spawns, WASD wander past trees, farm plots, and animals. Overlay: "Monad Meadow — live on Monad testnet."
2. **0:05–0:10 — Together.** A second player wanders into frame; a chat bubble pops. Overlay: "Real-time multiplayer."
...
6. **CTA:** "Grab testnet MON from the faucet, connect your wallet, and come wander. https://monad-meadow.lorq.workers.dev — verified contract: 0xb1c49827eDB08AD2E34f002D962EB8B87B855296. @monad @monad_dev @geeky_kartikey"
